...
class TeacherController extends AbstractController
{
    ...
    /**
     * @Route("/showTeacher",name="showTeacher")
     */
...
theorique','date_debut'=>'10/06/2020','date_fin'=>'14/06/2020',
                'nb_participants'=>12));
        //retour avec paramètre
       //  return new Response("show teacher".$name);
        return  $this->render("teacher/show.html.twig",
            array('tabformation'=>$formations));
    }

    /**
     * @Route("/showMore/{Ref}",name="showFormation")
     */
    public function showMore($id)
    {

       return $this->render("teacher/showFormation.html.twig",
           array('ref'=>$Ref,'titre'=>$titre));
    }
